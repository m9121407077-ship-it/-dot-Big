...
موقعیت Al Mouj Muscat S.A.O.C. در لایه‌ی سوم (نه بالاتر، نه پایین‌تر) عمدی است. اگر در بالا قرار می‌گرفت، با Oman رقیب توجه می‌شد. اگر در پایین قرار می‌گرفت، در زیر سلسله‌مراتب گم می‌شد. لایه‌ی سوم نقطه‌ی تلاقی است که هم سه شریک JV به آن می‌رسند و هم zhànjiǎn نسبت به master development و project پایین‌تر است، که visually یعنی «همه‌چیز از اینجا شروع می‌شود». این موقعیت‌گذاری به اصل visual center of gravity در طراحی اطلاعاتی پاسخ می‌دهد.
